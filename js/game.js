...
Tower.game = {
  ...
  init: function () {
    ...
    var state = {
      ...
      killsByType: save.killsByType || { basic: 0, fast: 0, ranged: 0, tank: 0, boss: 0, hellfire: 0, goblin: 0 },
      waveKills: 0,
  ...
  ingameUpgrade: function (stat) {
    var state = this.state;
    // Allow upgrades during combat (matches original The Tower behavior)
    var lk = stat + 'Level';
